                ...
                if (!BitmapForma.can_write)
                    using (var graphics = Graphics.FromImage(forma.Image))
                    {
                        foreach (TwoPoints tp in m_list)
                        {
                            ...
                            {
                                graphics.FillEllipse(m_brush, tp.point1.X, tp.point1.Y, tp.point2.X, tp.point2.Y);
                            }
                        ...
                        if (ToolsClass.AnotherPict != Color.White)
                        {
                            graphics.FillEllipse(m_brush, point1.X, point1.Y, point2.X, point2.Y);
                        }
                    }
                else
                {
                    ...
                    foreach (TwoPoints tp in m_list)
                    {
                        ...
                        if (ToolsClass.AnotherPict != Color.White)
                        {
                            grph.FillEllipse(m_brush, tp.point1.X, tp.point1.Y, tp.point2.X, tp.point2.Y);
                        }

                        grph.DrawEllipse(m_pen, point1.X, point1.Y, point2.X, point2.Y);
                        if (ToolsClass.AnotherPict != Color.White)
                        {
                            grph.FillEllipse(m_brush, point1.X, point1.Y, point2.X, point2.Y);
                        }
